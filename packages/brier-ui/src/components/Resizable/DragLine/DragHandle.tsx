...
export const DragHandle = memo(({ start, onDraggingChange }: DragHandleProps) => {
  ...
  return (
    <div
      ...
      className="group absolute top-0 -right-0.75 z-10 h-full w-1.5 cursor-col-resize touch-none"
    >
      <div
